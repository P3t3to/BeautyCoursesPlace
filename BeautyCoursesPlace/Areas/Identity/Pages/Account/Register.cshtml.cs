...
namespace BeautyCoursesPlace.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(UserFirstNameMax,MinimumLength=UserFirstNameMin)]
            public string FirstName { get; set; }


            [Required]
            [Display(Name = "Last Name")]
            [StringLength(UserLastNameMax, MinimumLength = UserLastNameMin)]
